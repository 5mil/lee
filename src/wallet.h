...
enum WalletFeature
{
    ...
    FEATURE_WALLETCRYPT = 40000, // wallet encryption input < comprepubkey to avoid exploit
...
enum AvailableCoinsType
{
    ...
    ONLY_NONDENOMINATED_NOTMN = 4 // ONLY_NONDENOMINATED and not 1000 lee at the same time
};
